...
happyExpList = HappyA# "\x80\x01\x60\x00\x00\x00\x06\x00\x08\x00\x01\x00\x00\x08\x00\x04\x80\x00\x00\x00\x40\x00\x00\x00\x01\x20\x00\x00\x00\x10\x00\x00\x00\x00"#
...
happyActOffsets = HappyA# "\x03\x00\x03\x00\x00\x00\x03\x00\x06\x00\x08\x00\x09\x00\x0a\x00\x0b\x00\x0e\x00\x00\x00\x04\x00\x00\x00\x0f\x00\x11\x00\x00\x00\x0c\x00\x00\x00\x00\x00"#

happyGotoOffsets :: HappyAddr
happyGotoOffsets = HappyA# "\x01\x00\x05\x00\x00\x00\x07\x00\x00\x00\x12\x00\x00\x00\x00\x00\x13\x00\x00\x00\x00\x00\x00\x00\x00\x00\x14\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"#

happyAdjustOffset :: Happy_GHC_Exts.Int# -> Happy_GHC_Exts.Int#
happyAdjustOffset off = off

happyDefActions :: HappyAddr
happyDefActions = HappyA# "\x00\x00\x00\x00\xfe\xff\xfd\xff\x00\x00\x00\x00\x00\x00\x00\x00\xf9\xff\x00\x00\xfc\xff\x00\x00\xf8\xff\x00\x00\x00\x00\xfb\xff\x00\x00\xfa\xff"#

happyCheck :: HappyAddr
happyCheck = HappyA# "\xff\xff\x00\x00\x01\x00\x02\x00\x01\x00\x02\x00\x01\x00\x02\x00\x01\x00\x02\x00\x06\x00\x05\x00\x04\x00\x03\x00\xff\xff\x04\x00\x07\x00\x03\x00\x06\x00\x04\x00\x03\x00\x03\x00\x03\x00\x03\x00\xff\xff\xff\xff\xff\xff\xff\xff"#

happyTable :: HappyAddr
happyTable = HappyA# "\x00\x00\x06\x00\x02\x00\x03\x00\x05\x00\x06\x00\x02\x00\x03\x00\x0a\x00\x03\x00\x10\x00\x0a\x00\x09\x00\x0e\x00\x00\x00\x09\x00\xff\xff\x0c\x00\x12\x00\x09\x00\x11\x00\x07\x00\x0c\x00\x0e\x00\x00\x00\x00\x00\x00\x00\x00\x00"#
...
happyReduction_4 (happy_x_4 `HappyStk`
	...
	happy_x_1 `HappyStk`
	happyRest)
	 = case happyOutTok happy_x_2 of { (TokenStr happy_var_2) -> 
	case happyOutTok happy_x_4 of { (TokenName happy_var_4) -> 
	happyIn6
...
happyReduction_5 (happy_x_6 `HappyStk`
	...
	case happyOutTok happy_x_6 of { (TokenName happy_var_6) -> 
	happyIn6
...
happyReduction_6 happy_x_1
	 =  case happyOutTok happy_x_1 of { (Check happy_var_1) -> 
	happyIn7
...
happyNewToken action sts stk (tk:tks) =
	...
	StringT -> cont 2#;
	Sep -> cont 3#;
	Check happy_dollar_dollar -> cont 4#;
	TokenStr happy_dollar_dollar -> cont 5#;
